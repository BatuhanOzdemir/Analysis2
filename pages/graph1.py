...
st.subheader("Distribution of Salaries for Turkish and German Teams")
salary1 = sns.histplot(data=df_turkey, x='Monthly Gross Wage', label='Turkey', alpha=0.5)
salary2 = sns.histplot(data=df_germany, x='Monthly Gross Wage', label='Germany', alpha=0.5)
st.pyplot(salary1.get_figure())
st.pyplot(salary2.get_figure())
st.subheader("Salary vs Age for Turkish and German Teams")
age1 = sns.scatterplot(data=df_turkey, x='Age', y='Monthly Gross Wage', hue='Education', style='Position.1')
age2 = sns.scatterplot(data=df_germany, x='Age', y='Monthly Gross Wage', hue='Education', style='Position.1')
st.pyplot(age1.get_figure())
st.pyplot(age2.get_figure())
st.subheader("Average Salary For Each Position In German Team")
